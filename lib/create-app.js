...
function setupNotifications(userId) {
    ...
    if (!notificationsSetup) {
        // Set up daily reminders at specific times
        notificationManager.setupDailyReminders(['09:00', '15:00', '20:00']);
        
        // Or set up notifications every 4 hours
        // notificationManager.scheduleRecurringNotifications({
        //     title: \`Hi \${userId}, time for your experiment!\`,
        //     text: 'Your daily jsPsych task is ready',
        //     interval: 240 // every 4 hours (240 minutes)
        // });
        
        // Or set up experience sampling (random notifications)
        // notificationManager.setupExperienceSampling({
        //     startHour: 8,
        //     endHour: 22,
        //     minInterval: 120,
        //     maxInterval: 240,
        ...
        console.log('Notifications set up for user:', userId);
    }
}
